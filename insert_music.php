...
<main>
  ...
  <div class="container">
      ...
      <legend>Nova Música</legend>

      <form method="POST" action="controller/control_add_music.php">
        <div class="form-group">
         <label for="name">Nome</label>
         <input type="text" class="form-control" name="name" id="name" autofocus required placeholder="Nome da música" >
       </div>
       <div class="form-group">
         <label >Banda</label>
         <select class="form-control" name="band">
          ...
          <option value="<?php echo $band['id_band']; ?>" > <?php echo $band['name_band']; ?></option>  
    ...
    <div class="form-group">
            ...
            <div class="radio">
              <label>
               <input type="radio" name="level" required value="<?php echo $level['id_level']; ?>"> <?php echo $level['name_level']; ?>  <img src="public/<?php echo $level['name_level']; ?>.png" class="img-responsive center-block">   
             </label>
           </div>
           <?php } ?>
