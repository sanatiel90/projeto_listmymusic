  	...
  	<main>
  		...
  		<div class="container">
			...
			<legend>Editar Banda</legend>
  				...
  				<form method="POST" action="controller/control_update_band.php">
  					<div class="form-group">
  						<label for="name">Nome</label>
  						<input type="text" class="form-control" name="name" value="<?php echo $band[0]['name_band']; ?>" >
  					</div>
					
 				
 						<input type="hidden" value="<?php echo $band[0]['id_band']; ?>" name="id">
